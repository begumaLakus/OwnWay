...
def db_write(rows):
    with psycopg2.connect(**DB) as conn, conn.cursor() as cur:
        ...
        cur.execute("SELECT u.id, c.city_name, u.uni_name, u.uni_type, u.has_campus, u.campus_count FROM universities u JOIN cities c ON c.id = u.city_id ORDER BY c.city_name, u.uni_name;")
